...
export function ModalUpdateDevice ({ onClose, itemId }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const data = await getDevicesInfo(itemId);
            console.log('?', data)
            setName(data.device_name);
            setDepartment(data.department);
            setDevice_uid(data.device_uid);
            setDeviceMode(data.device_mode ? 'normal' : 'exam');
          } catch (e) {
    ...
    const handleUpdateUser  = async (e) => {
        ...
        try {
            ...
            await updateDevice(formData, itemId);
                            ...
                            <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <div className="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                            <input
                                                id="normal-class-radio" 
                                                type="radio" 
                                                value="normal" 
                                                name="device_mode" 
                                                checked={deviceMode === 'normal'} 
